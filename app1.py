...
#分割数据集
data=pd.read_csv('乳腺癌骨转移数据-标准后.csv')
data['status'].value_counts()
data_featureCata=data[['pathological_type','T']]
data_featureNum=data[['CEA','CA125','CA153','LDH','TBIL','UA']]
...
model=RandomForestClassifier(criterion='entropy', max_depth=4, n_estimators=193,bootstrap=False,random_state=172)
